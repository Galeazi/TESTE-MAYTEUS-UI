class EnderecoPage {
    ...
    editarEnderecoFaturamento(nome, sobrenome, empresa, pais, endereço, numero, cidade, estado, cep, celular, email) {
    ...
    editarEnderecoEntrega(nome, sobrenome, empresa, pais, endereço, numero, cidade, estado, cep) {
        cy.get('.woocommerce-MyAccount-navigation-link--edit-address > a').click()
